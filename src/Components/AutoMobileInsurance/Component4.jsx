    ...
    <div className="bg-white pb-40 pt-5">
      <div className="flex flex-col justify-center items-center py-10 mx-auto w-[90%] gap-20 mt-40 pb-40">
        ...
        <div className="flex flex-col sm:flex-row sm:flex-wrap text-sm gap-10 justify-center">
          <div className="border-2 border-gray-400 rounded-lg p-7 text-start flex flex-col w-full sm:w-1/5">
          ...
          <div className="border-2 border-gray-400 rounded-lg p-7 text-start flex flex-col w-full sm:w-1/5">
            <div className="text-lg font-bold mb-5 pr-10">
              Compare your quotes
            </div>
          ...
          <div className="border-2 border-gray-400 rounded-lg p-7 text-start flex flex-col w-full sm:w-1/5">
            ...
            <div className="font-bold md:mt-5">
            Get a free quote &#62;
            </div>
