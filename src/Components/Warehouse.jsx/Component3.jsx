    ...
    return (
        <div className="flex flex-col justify-center items-center py-10 mx-auto gap-10">
              <div className="text-lg text-center p-2">
                <div className="text-lg md:text-3xl font-bold">Warehouse Insurance Coverage</div>
                <p className="text-sm font-medium mx-auto mt-5">
                Warehouses insurance coverage protects businesses against
                </p>
              </div>
              <div className="flex flex-col sm:flex-row sm:flex-wrap text-sm gap-10 justify-center p-5 md:p-20 md:pt-10">
                ...
                <div className="border-2 border-gray-200 rounded-sm p-5 text-start flex flex-col w-full sm:w-1/5">
                  <div className="text-lg font-semibold mb-5">Product Liability</div>
                  <p>
                ...
                <div className="border-2 border-gray-200 rounded-sm p-5 text-start flex flex-col w-full sm:w-1/5">
                  <div className="text-lg font-semibold mb-5">Breach of Contract</div>
                  <p>
