        ...
        <div className="flex flex-col gap-5">
          <div className="flex justify-between items-center">
            <p className="text-sm font-semibold md:ml-5 mt-10">
              If I use my personal vehicle for work and get into an accident,
              will my personal car insurance policy pay for damages?
            </p>
            <p>^</p>
          </div>
          <div className="bg-[#F5F5F5] text-sm p-5 rounded-2xl">
            Not necessarily. If the insurer for your existing personal auto
            policy is unaware you are using your private vehicle for business
            purposes, they could deny any claim you file. That means you will be
            on your own to cover the cost of repairing or replacing your
            vehicle. Furthermore, your personal auto policy could be cancelled
            by the insurer for not notifying them you use your vehicle for work.
            If an insurer cancels your personal auto policy, it will cause your
            premium to rise significantly.
          </div>
        </div>
        <div className="flex flex-col gap-5">
          <div className="flex justify-between items-center">
          ...
          <div className="bg-[#F5F5F5] text-sm p-5 rounded-2xl">
            General liability insurance typically includes coverage for legal
            costs and damages related to the following coverage areas:
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="bg-[#F5F5F5] text-sm p-5 rounded-2xl">
            <ul className="list-disc pl-5">
              ...
              <li>Drive less : How much you drive is a key factor. Look for ways to reduce the amount of time you spend behind the wheel.</li>
              <li>Safety and security : Install aftermarket security systems and park in secure locations.</li>
              <li>Mitigate threats : Implementing risk management practices to prevent accidents and claims.</li>
              <li>Minimize theft : Installing an anti-theft device to deter theft will reduce your rate.</li>
              <li>Monitor driving habits : Using an usage-based insurance or telematics device to monitor and promote safe driving will help reduce your premiums.</li>
            </ul>
          </div>
        </div>
      </div>
