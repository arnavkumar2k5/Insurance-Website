      ...
      <div>
        <div className="flex flex-col gap-5">
          ...
          >
            ...
            <p>{openIndex === 0 ? <span className="font-bold text-3xl">&#xfe40;</span> : <span className="font-bold text-3xl">&#xfe3f;</span>}</p>
          </div>
          {openIndex === 0 && (
        ...
        <div className="flex flex-col gap-5">
          ...
          >
            ...
            <p>{openIndex === 1 ?<span className="font-bold text-3xl">&#xfe40;</span> : <span className="font-bold text-3xl">&#xfe3f;</span>}</p> 
          </div>
          {openIndex === 1 && (
            <div className="bg-[#F5F5F5] text-sm p-5 rounded-2xl">
        ...
        <div className="flex flex-col gap-5">
          ...
          >
            ...
            <p>{openIndex === 2 ? <span className="font-bold text-3xl">&#xfe40;</span> : <span className="font-bold text-3xl">&#xfe3f;</span>}</p> 
          </div>
          {openIndex === 2 && (
            <div className="bg-[#F5F5F5] text-sm p-5 rounded-2xl">
        ...
        <div className="flex flex-col gap-5">
          ...
          >
            ...
            <p>{openIndex === 3 ? <span className="font-bold text-3xl">&#xfe40;</span> : <span className="font-bold text-3xl">&#xfe3f;</span>}</p> 
          </div>
          {openIndex === 3 && (
            <div className="bg-[#F5F5F5] text-sm p-5 rounded-2xl">
        ...
        <div className="flex flex-col gap-5">
          ...
          >
            ...
            <p>{openIndex === 4 ? <span className="font-bold text-3xl">&#xfe40;</span> : <span className="font-bold text-3xl">&#xfe3f;</span>}</p>
          </div>
          {openIndex === 4 && (
            <div className="bg-[#F5F5F5] text-sm p-5 rounded-2xl">
